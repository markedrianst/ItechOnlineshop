                ...
                <div class="div_center">
                    ...
                    <table class="center">
                      <tr class="th_color">
                        ...
                        <th class="th_deg" colspan=3>Action</th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td >{{$product->discounted_price}}</td>
                            <td>
                               <a href="{{url('delete_product',$product->id)}}"onclick="return confirm('Are you sure do you want to delete this product {{$product->product_name}}?')"class="btn btn-danger">Delete</a>
                            </td>
                            <td>
